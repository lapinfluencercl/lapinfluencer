...
function addToCart(name, price, category = categoryKey, quantity = 1) {
...
optionsEl.addEventListener("click", (event) => {
  ...
  addToCart(`${baseName}${color}${addonName}`, `${basePrice}${addonPrice}`, categoryKey, quantityFromCard(card));
});
